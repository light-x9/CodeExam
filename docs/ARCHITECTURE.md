> 👉 [返回 README](README.md) — 项目快速概览
>
﻿# 智能学习系统 (AI Exam System) — 项目完整架构分析

> **适用读者**：Java 后端初学者，正在学习 Spring Boot + MyBatis-Plus + Redis + JWT 技术栈。

CodeExam（云学宝）是一个**前后端分离的智能在线学习平台**，基于 Spring Boot 3 + MySQL + Redis + Redisson + MinIO + JWT 构建，集成 AI 智能出题与主观题异步批改能力，支持在线考试、题库管理、视频资源学习等核心功能，旨在为学生和教师提供高效、智能的在线学习与评测体验。

---

## 一、项目概览

这是一个**前后端分离的智能在线学习平台**，包含以下核心能力：
